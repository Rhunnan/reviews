...
const ReviewsArticle = () => {
    ...
    const checkIndex = (indexNumber: number) =>{
    ...
    return(
        ...
        <>
        <main>
        {/* put this article later in another file */}
        <article className="review">
          {/* images in the article with the qoute */}
          ...
          {/* text in the artice the name the job the info */}
